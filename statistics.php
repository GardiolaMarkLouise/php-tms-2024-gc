...
$(document).ready(function() {
    ...
    function filterTable(gender, status) {
        var filteredData = originalData.filter(function(rowData) {
            return (gender === 'All' || rowData[6] === gender) && (status === 'All' || rowData[7] === status);
        });
...
$(document).ready(function() {
    ...
    function updateCounts() {
        ...
        var maleCount = filteredData.filter(function(row) { return row[6] === 'Male'; }).count();
        var femaleCount = filteredData.filter(function(row) { return row[6] === 'Female'; }).count();
